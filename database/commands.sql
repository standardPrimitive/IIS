...
INSERT INTO `Trip` (`route_ID`, `driver`, `user`, `date_depart`, `travel_conditions`, `price`) VALUES
    (1, 21, 1, '2023-12-20', 'Не курить, без животных', 400),
    (2, 22, 2, '2023-12-21', 'Без громкой музыки', 550),
    (3, 23, 3, '2023-12-22', 'Люблю поговорить', 700),
    (4, 24, 4, '2023-12-23', 'Без разговоров', 850),
    (5, 25, 5, '2023-12-24', 'Люблю музыку', 1000),
    (6, 26, 6, '2023-12-25', 'Не курить, без животных', 450),
    (7, 27, 7, '2023-12-26', 'Без разговоров', 600),
    (8, 28, 8, '2023-12-27', 'Люблю поговорить', 750),
    (9, 29, 9, '2023-12-28', 'Без громкой музыки', 900),
    (10, 30, 10, '2023-12-29', 'Люблю музыку', 1050),
    (11, 31, 11, '2023-12-20', 'Без разговоров', 500),
    (12, 32, 12, '2023-12-21', 'Не курить, без животных', 650),
    (13, 33, 13, '2023-12-22', 'Люблю музыку', 800),
    (14, 34, 14, '2023-12-23', 'Без громкой музыки', 950),
    (15, 35, 15, '2023-12-24', 'Люблю поговорить', 1100),
    (16, 36, 16, '2023-12-25', 'Без громкой музыки', 550),
    (17, 37, 17, '2023-12-26', 'Люблю музыку', 700),
    (18, 38, 18, '2023-12-27', 'Без разговоров', 850),
    (19, 39, 19, '2023-12-28', 'Не курить, без животных', 1000),
    (20, 40, 20, '2023-12-29', 'Люблю поговорить', 1150);
